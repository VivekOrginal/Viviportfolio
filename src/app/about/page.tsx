...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "viveksubhash4@gmail.com",
    href: "mailto:viveksubhash4@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/vivek-p-s-158817282",
    content: "/vivek-p-s-158817282",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/VivekOrginal",
    content: "/VivekOrginal",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Vivek PS</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Vivek PS, a Computer Science Engineer with experience in Development, DevOps and 
